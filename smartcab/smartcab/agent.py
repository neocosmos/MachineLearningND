...
class LearningAgent(Agent):
	...
	self.t = 0               # counter for number of trials
	self.a_epsilon = 0.005           # decay parameter cos(at)  for epsilon
	self.a_alpha   = 0.007           # decay parameter cos(at)  for alpha
    ...
    def reset(self, destination=None, testing=False):
		...
		self.epsilon = math.cos(self.a_epsilon*self.t)
		self.alpha   = 0.65*math.exp(-1*self.a_alpha*self.t)
		#if self.t: 
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning = True, alpha=0.65, epsilon = 1.0)
